...
import { darkText, flyoutBackground, lightGray, pandaPink, defaultBackground } from '../../other/colors';
...
const ForwardButton = styled.button`
  ...
  background-color: ${(props) => {
    return props.buttonColor ? props.buttonColor : props.isGrayButton ? defaultBackground : flyoutBackground;
  }};
  border: none;
  opacity: 0.6;
...
export default class HorizontalList extends React.Component {
  ...
  itemsRenderer = (items, ref) => (
    <ContainerWithArrowButtons>
      ...
      <OuterContentContainer innerRef={this.getScrollRowRef} isCentered={this.props.isCentered}>
        <InnerContentContainer innerRef={ref}>{items}</InnerContentContainer>
