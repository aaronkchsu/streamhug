...
class OutsideBoardLink extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  openBoardLink = () => {
    window.open(`https://blerp.com/soundboard/${this.props.id}`, "_blank");
  }
...
export default OutsideBoardLink;
